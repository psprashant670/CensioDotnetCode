using System;
using Domain.Game4Data;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.Metadata;

namespace DataAccess.EFCore.Game4Data
{
    public partial class db_cencio_game4Context : DbContext
    {
        public db_cencio_game4Context()
        {
        }

        public db_cencio_game4Context(DbContextOptions<db_cencio_game4Context> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblGame4LevelInstructions>(entity =>
            {
                ...
                entity.HasOne(d => d.IdLevelNavigation)
                    .WithMany(p => p.TblGame4LevelInstructions)
                    .HasForeignKey(d => d.IdLevel)
                    .HasConstraintName("id_level");
            });
            ...
            modelBuilder.Entity<TblGame4Userlog>(entity =>
            {
                ...
                //entity.HasOne(d => d.IdLevelMaster)
                //    .WithMany(p => p.TblGame4Userlog)
                //    .HasForeignKey(d => d.IdLevelMasterid)
                //    .HasConstraintName("id_level_masterid");
            });
            ...
            modelBuilder.Entity<TblGame4WordMaster>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdLevelMaster)
                    .HasName("id_level_master_idx");
                ...
                entity.HasOne(d => d.IdLevelMasterNavigation)
                    .WithMany(p => p.TblGame4WordMaster)
                    .HasForeignKey(d => d.IdLevelMaster)
                    .HasConstraintName("id_level_master");
            });
            ...
            modelBuilder.Entity<TblGame4WordsLog>(entity =>
            {
                ...
                entity.HasIndex(e => e.IdUserlog)
                    .HasName("id_userlog_idx");
                ...
                //entity.HasOne(d => d.IdUserlogNavigation)
                //    .WithMany(p => p.TblGame4WordsLog)
                //    .HasForeignKey(d => d.IdUserlog)
                //    .HasConstraintName("id_userlog");
            });
